...
/// @nodoc
abstract class $CharacterResultCopyWith<T, $Res> {
  factory $CharacterResultCopyWith(
          CharacterResult<T> value, $Res Function(CharacterResult<T>) then) =
      _$CharacterResultCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$CharacterResultCopyWithImpl<T, $Res>
    implements $CharacterResultCopyWith<T, $Res> {
  _$CharacterResultCopyWithImpl(this._value, this._then);

  final CharacterResult<T> _value;
  // ignore: unused_field
  final $Res Function(CharacterResult<T>) _then;
}
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$CharacterResultCopyWithImpl<T, $Res>
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'CharacterResult<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements CharacterResult<T> {
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CharacterResult<$T>.erro(message: $message)';
  }
...
abstract class Error<T> implements CharacterResult<T> {
